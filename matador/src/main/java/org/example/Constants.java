...
public class Constants {
        ...
        public static Color[] PLAYER_COLORS = { Color.RED, Color.GREEN, Color.BLUE, Color.ORANGE, Color.PINK,
                        Color.YELLOW };
        public static Color[] TILE_COLORS = { Color.BLUE, Color.ORANGE, Color.YELLOW, Color.RED, Color.GRAY,
                        Color.WHITE,
                        PURPLE };
        ...
        // Buy houses
        public static final String BUY_HOUSE = "Køb et hus";
        public static final String BUY_ALL_HOUSES = "Køb alle huse for denne farve";
        public static final String SELL_HOUSE = "Sælg et hus";
        public static final String SELL_ALL_HOUSES = "Sælg alle huse for denne farve";
