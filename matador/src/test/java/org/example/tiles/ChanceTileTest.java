...
class ChanceTileTest {
    ...
    void tileAction() {
        ...
        try{
            ...
            Chance chance = new PaymentChance(-1000,"De har kørt frem for “fuldt stop”, Betal 1000 kroner i bøde");
            ArrayList<Chance> chanceArrayList = new ArrayList<Chance>();
            chanceArrayList.add(chance);

            ChanceTile chanceTile = new ChanceTile(1);
            chanceTile.tileAction(player,new Player[]{player}, chanceArrayList, new GUI());
